...
["main.gamestatus_not_found_tip_arm64"] = "গেম হয়তো এখনও লোড হচ্ছে, অথবা GameStatus মেমরিতে খুঁজে পাওয়া যায়নি।\n\nআপনি যদি এমুলেটরে থাকেন, তাহলে HCR2 চালানোর জন্য Multi App Ultra ব্যবহার করে দেখুন।",
["main.gamestatus_not_found_tip_x86"]   = "গেম হয়তো এখনও লোড হচ্ছে, অথবা GameStatus মেমরিতে খুঁজে পাওয়া যায়নি।\n\nআপনি যদি এমুলেটরে থাকেন, তাহলে ভালো সামঞ্জস্যের জন্য BlueStacks অথবা LDPlayer ব্যবহার করে দেখুন।",
...
["patches.no_data_this_version"] = "আপনার গেম সংস্করণের জন্য উপলব্ধ নয়।",
...
["creative.show_hidden_objects.applied"]  = "%sটি লুকানো অবজেক্ট আনলক করা হয়েছে।",
["creative.show_hidden_objects.reverted"] = "%sটি লুকানো অবজেক্ট পুনরুদ্ধার করা হয়েছে।",
-- shared errors
["creative.obj_anchor_not_found"] = "মেমরিতে অবজেক্ট গ্রুপ অ্যাঙ্কর খুঁজে পাওয়া যায়নি।",
["creative.obj_no_cache"]         = "পুনরুদ্ধার করার কিছু নেই — প্রথমে এটি চালু করুন।",
["creative.obj_no_slots"]         = "প্রক্রিয়াকরণের জন্য কোনো অবজেক্ট গ্রুপ স্লট পাওয়া যায়নি।",
["creative.obj_alloc_failed"]     = "মার্জড অবজেক্টের জন্য মেমরি বরাদ্দ করা যায়নি।",
["creative.obj_already_applied"]  = "ইতিমধ্যে সক্রিয় — প্রথমে এটি নিষ্ক্রিয় করুন।",
-- copy_any
["creative.copy_any.title"]        = "যেকোনো ট্র্যাক কপি করুন",
["creative.copy_any.desc"]         = "শুধু আপনার তৈরি করা নয়, যেকোনো ডাউনলোড করা ট্র্যাক কপি করতে দেয়।",
["creative.copy_any.applied"]      = "%sটি ডাউনলোড করা ট্র্যাক প্যাচ করা হয়েছে।",
-- track_editor
...
["creative.track_editor.no_tracks"] = "মেমরিতে কোনো কাস্টম ট্র্যাক পাওয়া যায়নি।",
-- error keys (returned from ops)
["creative.tracks_not_found"]      = "মেমরিতে কাস্টম ট্র্যাক তালিকা খুঁজে পাওয়া যায়নি।",
["creative.invalid_track"]         = "অবৈধ ট্র্যাক রেফারেন্স।",
["creative.copy_any_not_found"]    = "মেমরিতে ডাউনলোড করা ট্র্যাক তালিকা খুঁজে পাওয়া যায়নি।",
["creative.copy_any_no_id"]        = "প্লেয়ার আইডি রিজল্ভ করা যায়নি।",
["creative.rename_empty"]          = "নাম খালি রাখা যাবে না।",
["creative.rename_resolve_failed"] = "ট্র্যাক নাম পয়েন্টার রিজল্ভ করা যায়নি।",
-- track status
["creative.track_status.verified"]     = "ভেরিফাইড",
["creative.track_status.not_verified"] = "ভেরিফাইড নয়",
...
["creative.set_length.applied"] = "%s-এর দৈর্ঘ্য %sm সেট করা হয়েছে।",
...
["creative.rename.applied"] = "ট্র্যাকের নাম \"%s\" রাখা হয়েছে।",
...
["console.clear"] = "মুছুন",
["console.copied"] = "লগ ক্লিপবোর্ডে কপি করা হয়েছে",
["console.cleared"] = "কনসোল মুছে ফেলা হয়েছে",
["console.empty"] = "কোনো ক্র্যাশ বা সতর্কীকরণ রেকর্ড করা হয়নি।",
...
["settings.feedback.success_title"]       = "মতামত পাঠানো হয়েছে",
["settings.feedback.success_msg"]         = "ধন্যবাদ! আপনার মতামত প্রাপ্ত হয়েছে। ডেভেলপার এটি দেখবেন।",
["settings.feedback.failed_title"]        = "পাঠানো ব্যর্থ",
["settings.feedback.failed_msg"]          = "মতামত পাঠানো যায়নি। আপনার ইন্টারনেট সংযোগ পরীক্ষা করুন এবং আবার চেষ্টা করুন।",
...
["settings.console_crash_cap.desc"]  = "কনসোলে রাখা ক্র্যাশ এন্ট্রির সর্বোচ্চ সংখ্যা। বাফার পূর্ণ হলে পুরোনোগুলি প্রথমে বাদ পড়ে।",
...
["settings.console_cap_applied"] = "বাফার সীমা %s-এ সেট করা হয়েছে",
...
["settings.icon_style.desc"] = "মিনিমাইজ করা মেনু আইকন কেমন দেখায়",
["settings.icon_style.pill"] = "পিল (ডিফল্ট)",
["settings.icon_style.circle"] = "বৃত্ত",
["settings.icon_style.square"] = "গোলাকার বর্গক্ষেত্র",
["settings.icon_style.changed"] = "আইকন স্টাইল সেট করা হয়েছে: %s",
...
["other.aspect_ratio.applied"] = "আসপেক্ট রেশিও %s-এ সেট করা হয়েছে",
...
["player.speed_hack.not_found"] = "গতির মান পাওয়া যায়নি — প্রথমে একটি রেস শুরু করুন।",
...
["adventure.free_adventure_shop.reverted"]       = "মূল শপের দাম পুনরুদ্ধার করা হয়েছে।",
["adventure.free_adventure_shop.resolve_failed"] = "মেমরিতে অ্যাডভেঞ্চার শপ খুঁজে পাওয়া যায়নি — প্রথমে শপটি খুলুন।",
...
["cups.force_frenzy_mode.not_found"] = "Force Frenzy Mode পাওয়া যায়নি। পরে আবার চেষ্টা করুন।",
...
["account.change_ws.current_over_best_msg"]  = "বর্তমান উইন স্ট্রিক সেরা উইন স্ট্রিকের চেয়ে বড় হতে পারে না।",
["account.change_ws.resolve_failed"]         = "উইন স্ট্রিক পয়েন্টার রিজল্ভ করা যায়নি — নিশ্চিত করুন যে আপনি গেমের ভিতরে আছেন।",
["account.change_ws.applied"]                = "উইন স্ট্রিক সেট করা হয়েছে — বর্তমান: %s  সেরা: %s",
...
["account.fake_rank.applied"] = "নকল র‍্যাঙ্ক %s-এ সেট করা হয়েছে",
...
["vehicle.parts_modifier.prompt_digit1"] = "শেষ ডিজিট (১–৯) → তৈরি হয়: ১.<মাঝের…><শেষ>",
["vehicle.parts_modifier.prompt_reset"] = "মূল অবস্থায় রিসেট করুন",
["vehicle.parts_modifier.invalid"] = "অবৈধ লেভেল মান",
["vehicle.parts_modifier.status_cached"] = "সক্রিয়: %dটি ঠিকানা ক্যাশে করা হয়েছে",
["vehicle.parts_modifier.status_none"]   = "প্রয়োগ করা হয়নি",
